...
import cloudsim.ext.event.Accuracy_in_Retrieval;
import cloudsim.ext.event.Network_Usage;
import cloudsim.ext.event.Response_Time;
import cloudsim.ext.event.Service_Latency;
import cloudsim.ext.event.Success_Rate;
import cloudsim.ext.gui.SimulationUIElement;
import cloudsim.ext.event.Satisfaction_Rate;
 ...
 *
 */
public class EX_SimulationPanel extends JPanel implements CloudSimEventListener {
	/**
	 *
	 */
	...
	public void setResults(Map<String, Object> results) throws IOException, IOException{
		...
		repaint();
              ...
              Response_Time.main(null); 
              Satisfaction_Rate.main(null);
              Accuracy_in_Retrieval.main(null);
              Network_Usage.main(null);
              Service_Latency.main(null);
              Success_Rate.main(null);
      
                 //final graph demo = new graph("Verification Results of Shibboleth Protocol");
       // demo.pack();
