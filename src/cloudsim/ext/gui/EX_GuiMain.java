...
import cloudsim.ext.gui.screens.EX_ConfigureSimulationPanel;
import cloudsim.ext.gui.screens.InternetCharacteristicsScreen;
import cloudsim.ext.gui.screens.ResultsScreen;
import cloudsim.ext.gui.screens.EX_SimulationPanel;
 ...
 *
 */
public class EX_GuiMain extends JFrame implements ActionListener, CloudSimEventListener {
...
//private static final String CMD_ABOUT = "About";
	...
	private EX_ConfigureSimulationPanel configScreen;
	private EX_SimulationPanel simulationPanel;
	...
	/** No args constructor */
	public EX_GuiMain() throws Exception{	
	...
	private void showHomeScreen(){
		...
		if (simulationPanel == null){
			...
			simulationPanel = new EX_SimulationPanel();
	...
	private void showConfigureScreen(){
		...
		if (configScreen == null){
			configScreen = new EX_ConfigureSimulationPanel(simulation, this);
...
//	}
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals(CMD_CONFIGURE_SIMULATION)){			
			...
			System.exit(0);
		} else if (e.getActionCommand().equals(EX_ConfigureSimulationPanel.CMD_DONE_CONFIGURATION)){
			if (configScreen.isValidConfiguration()){
				showHomeScreen();
			}
		} else if (e.getActionCommand().equals(EX_ConfigureSimulationPanel.CMD_CANCEL_CONFIGURATION)){
			showHomeScreen();
			...
			try {
				...
				JOptionPane.showMessageDialog(this, ex.getMessage());
                    ...
                    try {
                        ...
                        Logger.getLogger(EX_GuiMain.class.getName()).log(Level.SEVERE, null, ex);
                    }
		}	}
	...
	public void cloudSimEventFired(CloudSimEvent e) {
		if (e.getId() == CloudSimEvents.EVENT_SIMULATION_ENDED){
			...
			double currSimTime = (Double) e.getParameter(EX_Constants.PARAM_TIME);
			progressBar.setValue((int) (currSimTime / 1000));
		}
	}
	
	private void showOnScreenResults() throws IOException{
