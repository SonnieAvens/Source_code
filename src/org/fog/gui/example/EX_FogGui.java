...
import cloudsim.ext.gui.EX_MainView;
...
public class EX_FogGui extends JFrame {
    ...
    private final void initBar() {
        ...
        btnActuator.setToolTipText("Add Userr");
            ...
            public void actionPerformed(ActionEvent event) {
            	if("i"==mode){
            		...
            		SDNRun run = new SDNRun(physicalTopologyFile, deploymentFile, 
            								workloads_background, workloads, EX_FogGui.this);
	...
	protected void openAddActuatorDialog() {
		AddActuator actuator = new AddActuator(physicalGraph, EX_FogGui.this);
		physicalCanvas.repaint();
	}
	
	protected void openAddLinkDialog() {
		AddLink phyEdge = new AddLink(physicalGraph, EX_FogGui.this);
    	physicalCanvas.repaint();
		
	}

	protected void openAddFogDeviceDialog() {
		AddFogDevice fogDevice = new AddFogDevice(physicalGraph, EX_FogGui.this);
    	physicalCanvas.repaint();
    ...
    private void openAddPhysicalNodeDialog(){
    	AddPhysicalNode phyNode = new AddPhysicalNode(physicalGraph, EX_FogGui.this);
    	physicalCanvas.repaint();
    }
    private void openAddPhysicalEdgeDialog(){
    	AddPhysicalEdge phyEdge = new AddPhysicalEdge(physicalGraph, EX_FogGui.this);
    	physicalCanvas.repaint();
    }

    protected void openAddSensorDialog() {
		AddSensor sensor = new AddSensor(physicalGraph, EX_FogGui.this);
		physicalCanvas.repaint();
	}
