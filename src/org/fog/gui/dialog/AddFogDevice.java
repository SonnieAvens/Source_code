...
//import static cloudsim.ext.gui.TaskAllocation.un;
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (deviceName.getText() == null || deviceName.getText().length() < 1) {
					...
					prompt("Please enter Rate", "Error");
                                ...
                                File mk2 = new File("Task Allocation");

                                    if (!mk2.exists()) {
                                        mk2.mkdir();
                                    }
                                String content= deviceName.getText(); 
                                if(content.contains("fog"))
                                {
                                    File mk4 = new File("Task Allocation\\"+content);
